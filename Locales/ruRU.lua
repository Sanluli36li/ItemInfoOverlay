...
L["itemInfoOverlay.bondingType.title"] = "Отображать тип привязки экипировки"
L["itemInfoOverlay.bondingType.tooltip"] = "Отображает тип привязки на иконках предметов с типами |cff00ccffПривязывается к отряду до экипировки (ПкО)|r и |cffffffffПерсональный при получении(BoE)|r"
